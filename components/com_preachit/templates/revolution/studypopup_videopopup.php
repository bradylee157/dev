...
<div id="videopopup" class="pipage">
	...
	<div class="subtitle">
		...
		{
		echo ' '.JText::_('COM_PREACHIT_by').' '.strip_tags($this->message->teachername);}?>
		
		<?php if ($this->message->seriesname)
		{ ?>
		<div class="series"><?php echo JText::_('COM_PREACHIT_Series').':';?><span><?php echo strip_tags($this->message->seriesname);?></span></div>
		<?php } ?>
	...
	<div class="medialinks">
		...
		<?php if ($this->message->downloadvid)
		{?>
		<span class="videolinks"><?php echo JText::_('COM_PREACHIT_Video').':';  echo $this->message->downloadvid;?></span>
		<?php } ?>
		
		<?php if ($this->message->linklisten || $this->message->downloadaud)
		{?>	
		<span class="audiolinks"><?php echo JText::_('COM_PREACHIT_Audio').':'; echo $this->message->linklisten; echo $this->message->downloadaud;?></span>
		<?php } ?>
