...
<div id="textview" class="pipage">
	...
	{ ?>
	<div class="duration"><?php echo JText::_('Duration').':';?><span><?php echo $this->message->duration;?></span></div>
	<?php } ?>
	<?php }?>
		...
		<div class="shareprint"> 
			<?php if ($params->get('share', '1') == '1')
 				{ ?>
					...
					<?php } ?>
				<?php } ?>	
			<?php if ($params->get('print_text', '1') == 1)
				{?>
	...
	<?php if ($params->get('show_2links_text', 0) == 1)
 	{?>
