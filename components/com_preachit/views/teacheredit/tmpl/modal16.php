...
<h2>
<?php if ($this->id)
{echo JText::_('COM_PREACHIT_ADMIN_TEACHERS_EDIT');}
else { echo JText::_('COM_PREACHIT_ADMIN_TEACHERS_DETAILS');}?>
</h2>
</div>
</fieldset>
<?php
...
<?php
echo $pane->endPanel();
if (!in_array('teacher_description', $this->hide))
{
...
<tr>
<td width="100" align="right" class="key">
<label class="label"><?php echo JText::_('COM_PREACHIT_ADMIN_IMAGE_UPLOAD_SELECTOR');?></label>
</td>
<td>
