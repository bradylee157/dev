...
<script type="text/javascript">
			...
			alert("<?php echo JText::_('COM_PREACHIT_JAVA_ENTER_NAME');?>");
				...
				var url = 'index.php?option=com_preachit&controller=studyedit&task=createrecord&format=raw&'+token+'&'+urldetails;	
				...
				var container = new Element('div', { 'class': 'meltempcontainer',
					...
					return false;}
					else {document.getElementById('pisubmit').innerHTML = '<div class="alert-neg"><?php echo JText::_('COM_PREACHIT_WAS_ERROR');?></div>';}
						}
		...
		<div class="edittitle"><img class="mesimage" src="components/com_preachit/assets/images/logo.png">
