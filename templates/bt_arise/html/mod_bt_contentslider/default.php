...
<?php if( $row->thumbnail ): ?>
						...
						<?php if( $showAuthor ): ?>
							...
							JHtml::_('link',JRoute::_('index.php?option=com_contact&view=contact&id='.$row->created_by),$row->author)); ?>
							</span>
							<?php endif; ?>
							<?php if( $showDate ): ?>
							<span class="bt-date"><?php echo JText::sprintf('COM_CONTENT_CREATED_DATE_ON', $row->date); ?>
							</span>
							<?php endif; ?>
						</div>
						<?php endif; ?>
