...
class HodumaViewCategories extends JView
{
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_HODUMA_MANAGER_CATEGORIES'), 'categories');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle(JText::_('COM_HODUMA_CATEGORIES'));
	}
}