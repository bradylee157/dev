...
class HodumaViewWizard extends JView
{
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_HODUMA_WIZARD'), 'wizard');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle(JText::_('COM_HODUMA_WIZARD'));
