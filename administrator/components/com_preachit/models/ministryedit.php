...
class PreachitModelMinistryedit extends JModelForm
{
	...
	public function getForm($data = array(), $loadData = true) 
        {
                ...
                $form = JForm::getInstance('com_preachit.ministryedit', 'ministryedit', array('control' => 'jform', 'load_data' => $loadData));
                return $form;
        }
