...
function getTotal()
  ...
  function getPagination()
  {
      ...
      function _buildContentWhere()
	{
		...
		$filter_state		= $app->getUserStateFromRequest( $option.'filter_statebk',		'filter_statebk', 5, 'int' );

		$where = array();

		if ($filter_state < 5) {
			$where[] = " #__pibooks.published =".(int) $filter_state;
		}
		if ($filter_state == 5) {
			$where[] = " #__pibooks.published = 1 OR #__pibooks.published = 0";
		}
