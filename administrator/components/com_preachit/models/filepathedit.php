...
class PreachitModelFilepathedit extends JModelForm
{
        ...
        public function getForm($data = array(), $loadData = true) 
        {
                ...
                $form = JForm::getInstance('com_preachit.filepathedit', 'filepathedit', array('control' => 'jform', 'load_data' => $loadData));
                return $form;
        }
