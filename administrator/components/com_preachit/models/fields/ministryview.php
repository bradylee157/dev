...
class JFormFieldMinistryview extends JFormField
{
/**
	 * The form field type.
	 *
...
protected function getInput()
	{		// Load the javascript and css
		...
		if (empty($title)) {
			$title = JText::_('COM_PREACHIT_VIEW_PARAMS_CHOOSE_MINISTRY');
		}

		$link = 'index.php?option=com_preachit&amp;view=ministrylist&amp;tmpl=component&amp;layout=modal&amp;function=jSelectChart_'.$this->id;
