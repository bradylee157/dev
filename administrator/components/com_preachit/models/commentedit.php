...
class PreachitModelCommentedit extends JModelForm
{
	...
	public function getForm($data = array(), $loadData = true) 
        {
                ...
                $form = JForm::getInstance('com_preachit.commentedit', 'commentedit', array('control' => 'jform', 'load_data' => $loadData));
                return $form;
        }
