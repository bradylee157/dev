...
class PreachitModelBibleversedit extends JModelForm
{
        ...
        public function getForm($data = array(), $loadData = true) 
        {
                ...
                $form = JForm::getInstance('com_preachit.bibleversedit', 'bibleversedit', array('control' => 'jform', 'load_data' => $loadData));
                return $form;
        }
