...
class PreachitModelShareedit extends JModelForm
{
        ...
        public function getForm($data = array(), $loadData = true) 
        {
                ...
                $form = JForm::getInstance('com_preachit.shareedit', 'shareedit', array('control' => 'jform', 'load_data' => $loadData));
                return $form;
        }
