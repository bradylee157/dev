...
class PreachitModelMediaplayersedit extends JModelForm
{
        ...
        public function getForm($data = array(), $loadData = true) 
        {
                ...
                $form = JForm::getInstance('com_preachit.mediaplayersedit', 'mediaplayersedit', array('control' => 'jform', 'load_data' => $loadData));
                return $form;
        }
