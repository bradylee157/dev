...
<th width="20%"><?php echo JText::_('COM_PREACHIT_ADMIN_ROLELIST');?></th>
...
<td>
<a class="pointer" onclick="if (window.parent) window.parent.<?php echo $function;?>('<?php echo $row->id; ?>', '<?php echo addslashes($row->teacher_name); ?>');">
<?php echo $row->teacher_name.' '.$row->lastname; ?></a>
</td>
<td>
...
?>
	      <tfoot><tr>
	      <td colspan="6"> <?php echo $this->pagination->getListFooter(); ?> </td></tr></tfoot>
</table>
