...
class PreachitViewShareedit extends JView
{
...
if ($this->id > 0)
{
JToolBarHelper::title( JText::_( 'COM_PREACHIT_ADMIN_SHARE_EDIT' ), 'share.png' );
}
else {
    JToolBarHelper::title( JText::_( 'COM_PREACHIT_ADMIN_SHARE_DETAILS' ), 'share.png' );
}
