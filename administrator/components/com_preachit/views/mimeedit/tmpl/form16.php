...
$document->addScript(JURI::root() . 'administrator/components/com_preachit/views/mimeedit/tmpl/submitbutton.js');
?>
<form class ="form-validate" action="index.php" method="post" name="adminForm" id="adminForm">
<div class="width-100">
<fieldset class="adminform">
<legend><?php echo JText::_('COM_PREACHIT_ADMIN_MIME_LEGEND');?></legend>
