...
<td>
<a class="pointer" onclick="if (window.parent) window.parent.<?php echo $function;?>('<?php echo $row->id; ?>', '<?php echo addslashes($row->ministry_name); ?>');"> 
<?php echo $row->ministry_name; ?></a>
</td>
<td>
