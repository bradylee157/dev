...
class PreachitViewMediaplayersedit extends JView
{
...
if ($this->id > 0)
{
JToolBarHelper::title( JText::_( 'COM_PREACHIT_ADMIN_MEDIAPLAYERS_EDIT' ), 'mediaplayer.png' );
}
else {
    JToolBarHelper::title( JText::_( 'COM_PREACHIT_ADMIN_MEDIAPLAYERS_DETAILS' ), 'mediaplayer.png' );
}
