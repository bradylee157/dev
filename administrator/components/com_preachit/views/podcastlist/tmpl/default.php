...
$link = JFilterOutput::ampReplace( 'index.php?option=' . $option . '&controller=podcastlist&task=edit&cid[]='. $row->id );
...
<input type="text" style="text-align: center" readonly="readonly" value="<?php echo $row->ordering;?>" size="5" name="order[]">
</td>
<td>
