...
$filter_state = $app->getUserStateFromRequest( $option.'filter_stateser', 'filter_stateser'. '', 'int' );
...
$this->assignRef('state_list', JHTML::_('select.genericList', $selectstate, 'filter_stateser', 'class="inputbox" size="1" onchange="this.form.submit()"', 'value', 'text', $filter_state ));
...
JToolBarHelper::title( JText::_( 'COM_PREACHIT_ADMIN_TITLE_SERIES' ), 'series.png');
