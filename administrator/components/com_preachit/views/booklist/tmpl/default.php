...
<th width="90%"><?php echo JText::_('COM_PREACHIT_ADMIN_NAMELIST');?></th>
</tr>
</thead>
<?php
...
$link = JFilterOutput::ampReplace( 'index.php?option=' . $option . '&controller=booklist&task=edit&cid[]='. $row->id );

//determine name column

if ($user->authorise('core.edit', 'com_preachit')) 
{
$name = '<a href="'.$link.'">'.$row->display_name.'</a>';}
else {$name = $row->display_name;}
