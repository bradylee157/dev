...
class PreachitViewBibleversedit extends JView
{
...
$row =& JTable::getInstance('Biblevers', 'Table');
...
$user    = JFactory::getUser();   
    if ($this->id > 0)
{
JToolBarHelper::title( JText::_( 'COM_PREACHIT_BIBLEVERS_TITLE_EDIT' ), 'version.png' );
}
else
{
JToolBarHelper::title( JText::_( 'COM_PREACHIT_BIBLEVERS_TITLE_DETAILS' ), 'version.png' );
}
