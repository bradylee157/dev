...
?>
<div class="pimessages<?php echo $moduleclass_sfx; ?> modhorizontal">
...
$link6 = '';
	...
	<tr>	
        <?php echo $image; ?>
		<td class="tdstudyname"><div class="studyname"><?php echo $title;?></div></td>	
		<td class="tdscripture"><?php echo $script;?></td>
		<td class="tddate"><?php echo $date;?></td>
		<td class="tdteacher"><?php echo $teacher;?></td>
		<td class="tdseries"><?php echo $series;?></td>
		<td class="tdmedialinks"><?php echo $medialinks;?></td>
	</tr>
	</table>
	<?php
}
