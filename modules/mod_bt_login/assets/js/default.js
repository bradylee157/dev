...
BTLJ(document).ready(function() {
	...
	if (btlOpt.MOUSE_EVENT =='click'){ 
		...
		BTLJ("#btl-panel-profile").click(function(){
			showProfile();
			return false;
		});
	}else{
	...
	BTLJ('#register-link a').click(function () {
...
function registerAjax(){
	...
	var datasubmit= "task=registration&name="+BTLJ("#btl-input-name").val()
